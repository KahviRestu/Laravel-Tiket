				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
                            ...
                            <form class="form-auth-small" action="/create" method="POST">
                                {{csrf_field()}}
                                <div class="form-group">
									<label for="signin-email" class="control-label sr-only">Name</label>
									<input type="text" class="form-control" id="signin-email" placeholder="Name" name="name">
								</div>
								<div class="form-group">
